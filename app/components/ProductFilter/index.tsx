    ...
    <div className="bg-white">
      <div>
        ...
        <main className="mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative z-0 flex items-baseline justify-between py-4 border-b border-gray-200">
          ...
          <div aria-labelledby="products-heading" className="pt-6 pb-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-x-8 gap-y-10">
              ...
              <div className="lg:col-span-3">
                ...
                <div className="border-2 border-dashed border-gray-200 rounded-lg h-96 lg:h-full inline-table lg:block p-4">
                  {children}
                </div>
                {/* /End replace */}
              </div>
